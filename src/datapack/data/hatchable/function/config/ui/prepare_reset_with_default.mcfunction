...
$execute if score #resetActive hatchable.temp matches 1.. run function hatchable:config/ui/reset/setting/active_with_default {path:"$(path)",return_function:"$(return_function)",per_player:$(per_player),player_tag:"$(player_tag)"}
